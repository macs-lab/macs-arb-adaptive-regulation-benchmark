...
if nargin<2, Fs = 800; ED = 32; Td = 5;nD =1; DD = 3; TL = 15;end
if nargin<3, ED = 32; Td = 5;nD =1; DD = 3; TL = 15;end
if nargin<4, Td = 5;nD =1; DD = 3; TL = 15;end
if nargin<5, nD = 1; DD = 3; TL = 15;end
if nargin<6, DD = 3; TL = 15;end
if nargin<7, TL = 15; end
